            ...
            <div data-repeater-item>
                <div class="form-group row">
                    <div class="col-md-2">
                      ...
                      <div class="col-md-2">
                        <label class="form-label">Expanse Group</label>
                        {{-- <input type="email" class="form-control mb-2 mb-md-0" placeholder="Enter full name" name="name1" id="check1"/> --}}
                        
                        <select class="form-control mb-2 mb-md-0" placeholder="Vehicles" id="sel1" wire:model="selectedExpenseGroup.{{$key}}">
                          <option value="" selected>Expanse Group</option>
                         @foreach ($expenseGroups[$key] as  $expenseGroup)
