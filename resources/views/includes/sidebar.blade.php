    ...
    <div class="aside-menu flex-column-fluid">
        ...
        <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="0">
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true" data-kt-menu-expand="false">
             ...
             @can('SideBar Whole Rental Company Section Show')
             <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                <span class="menu-link">
                    <span class="menu-icon">
                        <!--begin::Svg Icon | path: icons/duotune/ecommerce/ecm007.svg-->
                ...
                <div class="menu-sub menu-sub-accordion menu-active-bg">
              @can('SideBar Subsection Create New Company Show')
              <div class="menu-item">
             ...
             @endcan
                ...
                @can('SideBar Whole Vehicle Section Show')
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                    <span class="menu-link">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/ecommerce/ecm007.svg-->
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                            @can('SideBar Subsection Add New Vehicle Show')
                            <div class="menu-item">
                                <a class="menu-link" href="{{route('app.vehicle.index')}}">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                                    <span class="menu-title">Add new Vehicle</span>
                                </a>
                            </div> 
                            @endcan
                ...
                @endcan
                    ...
                    @can('SideBar Whole Company Section Show')
                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                        <span class="menu-link">
                            <span class="menu-icon">
                                <!--begin::Svg Icon | path: icons/duotune/ecommerce/ecm007.svg-->
                        ...
                        <div class="menu-sub menu-sub-accordion menu-active-bg">
                                @can('SideBar Subsection Add New Company Show')
                                <div class="menu-item">
                                    <a class="menu-link" href="{{route('app.company.index')}}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                    ...
                    @endcan
                        ...
                        @can('SideBar Whole Driver Section Show')
                        <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                            <span class="menu-link">
                                <span class="menu-icon">
                                    <!--begin::Svg Icon | path: icons/duotune/ecommerce/ecm007.svg-->
                            ...
                            <div class="menu-sub menu-sub-accordion menu-active-bg">
                                    @can('SideBar Subsection Add New Driver Show')
                                    <div class="menu-item">
                                        <a class="menu-link" href="{{route('app.driver.index')}}">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                                    ...
                                    @endcan
                                    @can('SideBar Subsection Driver Settings Show')
                                    <div class="menu-item">
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link" href="{{route('app.driver.show',[3])}}">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                        ...
                        @endcan
                            ...
                            @can('SideBar Whole Give On Rent Section Show')
                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                <span class="menu-link">
                                    <span class="menu-icon">
                                        <!--begin::Svg Icon | path: icons/duotune/ecommerce/ecm007.svg-->
                                    ...
                                    <span class="menu-title">Give on Rent</span>
                                    <span class="menu-arrow"></span>
                                </span>
                                <div class="menu-sub menu-sub-accordion menu-active-bg">
                                        @can('SideBar Subsection  New Rent Agreement Show')
                                        <div class="menu-item">
                                            <a class="menu-link" href="{{route('app.rentagreement.index')}}">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                                <span class="menu-title">New Rent Agreement</span>
                                            </a>
                                        </div> 
                                        @endcan
                            ...
                            @endcan
                                ...
                                @can('SideBar Whole Attendance Section Show')
                                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                    <span class="menu-link">
                                        <span class="menu-icon">
                                            <!--begin::Svg Icon | path: icons/duotune/ecommerce/ecm007.svg-->
                                    ...
                                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                                            @can('SideBar Subsection Create Driver Attendance Show')
                                            <div class="menu-item">
                                                <a class="menu-link" href="{{route('app.driverattendance.index')}}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            @endcan
                                                @can('SideBar Subsection Driver Attendance Report Show')
                                                <div class="menu-item">
                                ...
                                @endcan
                                    ...
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        ...
                                        <div class="menu-sub menu-sub-accordion menu-active-bg">
                                                @can('SideBar Subsection Give Salary Show')
                                                <div class="menu-item">
                                                    <a class="menu-link" href="{{route('app.account.show',[1])}}">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                        <span class="menu-title">Give Salary</span>
                                                    </a>
                                                </div> 
                                                @endcan
                                                    @can('SideBar Subsection Vehicle Expenses Show')
                                                    <div class="menu-item">
                                                    ...
                                                    @endcan
                                                        @can('SideBar Subsection Create Expense Group Show')
                                                        <div class="menu-item">
                                                        ...
                                                        @endcan
                                           @can('SideBar Subsection Rental Company Expenses Show')
                                           <div class="menu-item">
                                           ...
                                           @endcan
                                        @can('SideBar Subsection Pay Agreement Amount Show')
                                        <div class="menu-item">
                                            <a class="menu-link" href="{{route('app.account.show',[3])}}">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                                <span class="menu-title">Pay Agreement Amount</span>
                                            </a>
                                        </div> 
                                        @endcan
                                    ...
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        ...
                                        <div class="menu-sub menu-sub-accordion menu-active-bg">
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link" href="{{route('app.purchaseorder.show',[1])}}">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                        <span class="menu-title">Add New Supplier</span>
                                                    </a>
                                                </div> 
                                         
                                                  
                                                    <div class="menu-item">
                                                        <a class="menu-link" href="{{route('app.purchaseorder.show',[2])}}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link" href="{{route('app.purchaseorder.show',[3])}}">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link" href="{{route('app.purchaseorder.show',[4])}}">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link" href="{{route('app.purchaseorder.show',[6])}}">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link" href="{{route('app.purchaseorder.show',[9])}}">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                                <span class="menu-title">Goods Received Report</span>
                                                            </a>
                                                        </div> 
