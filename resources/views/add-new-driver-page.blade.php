                ...
                <div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" style="background-image: url(assets/media/illustrations/sketchy-1/14.png">
                    ...
                    <div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
                        ...
                        <div class="w-lg-600px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
                            ...
                            <!--begin::Form-->
                            <form class="form w-100" novalidate="novalidate" method="POST" action="{{route('app.driver.store')}}">
                                @csrf
                                <!--begin::Heading-->
                                ...
                                <div class="row mb-6">
                                    <!--begin::Label-->
                                     ...
                                     <!--begin::Col-->
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <input class="form-control form-control-lg form-control-solid" type="text" placeholder="Driver Name" name="name" value="{{old('name')}}"/>
                                        @error('name')
                                ...
                                <div class="row mb-6">
                                    <!--begin::Label-->
                                     ...
                                     <!--begin::Col-->
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <input class="form-control form-control-lg form-control-solid" type="text" placeholder="License" name="license" value="{{old('license')}}"/>
                                        @error('license')
                                        <span class="alert alert-danger" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="row mb-6">
                                    <!--begin::Label-->
                                     ...
                                     <!--begin::Col-->
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <input class="form-control form-control-lg form-control-solid" type="text" placeholder="Address" name="address" value="{{old('address')}}"/>
                                        @error('address')
                                        <span class="alert alert-danger" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="row mb-6">
                                    <!--begin::Label-->
                                     ...
                                     <!--begin::Col-->
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <input class="form-control form-control-lg form-control-solid" type="text" placeholder="Phone Number" name="phone" value="{{old('phone')}}"/>
                                        @error('phone')
                                        <span class="alert alert-danger" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="row mb-6">
                                    <!--begin::Label-->
                                     ...
                                     <!--begin::Col-->
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <input class="form-control form-control-lg form-control-solid" type="text" placeholder="Salary" name="salary" value="{{old('salary')}}"/>
                                        @error('salary')
                                        <span class="alert alert-danger" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="row mb-6">
                                    <!--begin::Label-->
                                     ...
                                     <!--begin::Col-->
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <input class="form-control form-control-lg form-control-solid" type="time" placeholder="Start Time" name="starttime" value="{{old('starttime')}}"/>
                                        @error('starttime')
                                        <span class="alert alert-danger" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="row mb-6">
                                    <!--begin::Label-->
                                     ...
                                     <!--begin::Col-->
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <input class="form-control form-control-lg form-control-solid" type="time" placeholder="End Time" name="endtime" value="{{old('endtime')}}"/>
                                        @error('endtime')
                                        <span class="alert alert-danger" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
